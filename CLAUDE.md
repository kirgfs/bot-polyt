...
> В папке `hl_scout/` лежит **отдельный проект**: скаут кошельков Hyperliquid для стороннего copy-бота. У него свои правила — `hl_scout/CLAUDE.md`. Код с Polymarket-ботом он не делит.
